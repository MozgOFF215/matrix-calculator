import { dateParse, mod, checkTriplet, checkTripletWithStyles } from './Utils'
...
// it('checkTriplet2', () => {
//   expect(checkTriplet2([1, 2, 3])).toEqual([])
//   expect(checkTriplet2([18, 12, 3], true)).toEqual([])
//   expect(checkTriplet2([18, 12, 3], false)).toEqual([{ id: "12-18-3" }])
// })

// it('checkTripletWithStyles', () => {
//   expect(checkTripletWithStyles([1, 2, 3])).toEqual([{ keys: [], value: 1 }, { keys: [], value: 2 }, { keys: [], value: 3 }])
//   expect(checkTripletWithStyles([3, 9, 12])).toEqual([{ keys: [], value: 1 }, { keys: [], value: 2 }, { keys: [], value: 3 }])
// })

it('checkTripletWithStyles', () => {
  expect(checkTripletWithStyles(6, 5, 11)).toEqual([{ keys: [], value: 1 }, { keys: [], value: 2 }, { keys: [], value: 3 }])
  expect(checkTripletWithStyles([3, 9, 12])).toEqual([{ keys: [], value: 1 }, { keys: [], value: 2 }, { keys: [], value: 3 }])
})